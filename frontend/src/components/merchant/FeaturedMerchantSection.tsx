    ...
    <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/60 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-3 sm:p-6">
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4">
        ...
        >
          ...
          <div className="flex-1 relative w-full overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
        ...
        {gridMerchants.map((merchant) => (
          ...
          >
            ...
            <div className="relative w-full" style={{ paddingBottom: '75%' }}>
              <div className="absolute inset-0 p-3 sm:p-4 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
                {merchant.logo_url ? (
                  <img
        ...
        >
          {/* Fixed aspect ratio matching other cards */}
          <div className="relative w-full" style={{ paddingBottom: '100%' }}>
            <div className="absolute inset-0 p-2 sm:p-2.5 flex flex-col items-center justify-center">
