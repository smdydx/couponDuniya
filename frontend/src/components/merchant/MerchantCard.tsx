          ...
          <div className="flex flex-col items-center text-center gap-2 h-full justify-center">
            ...
            <div className="w-full space-y-1">
              ...
              {merchant.default_cashback_value > 0 && (
                <Badge
                  variant="default"
                  className="bg-gradient-to-r from-purple-500 to-purple-600 text-white hover:from-purple-600 hover:to-purple-700 font-semibold text-xs px-2 py-0.5 shadow-sm"
                >
              ...
              {merchant.total_offers !== undefined &&
                merchant.total_offers > 0 && (
                  <div className="flex items-center justify-center gap-1 text-xs text-muted-foreground font-medium">
                    ...
                    <span>
                      {merchant.total_offers} offer
                      {merchant.total_offers > 1 ? "s" : ""}
                    </span>
                  </div>
                )}
            </div>
